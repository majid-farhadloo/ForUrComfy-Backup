...
public class SampleDataProvider {
    public static List<FoodMenu> dataItemList;
    public static Map<String, FoodMenu> dataItemMap;

    static {
        dataItemList = new ArrayList<>();
        dataItemMap = new HashMap<String, FoodMenu>();

        addItem(new FoodMenu(null, "Quinoa Salmon Salad", "Salads",
        ...
        addItem(new FoodMenu(null, "Chef's Salad", "Salads",
        ...
        addItem(new FoodMenu(null, "House Salad", "Salads",
        ...
        addItem(new FoodMenu(null, "Garden Buffet", "Salads",
                "Choose from our fresh local, organically grown ingredients to make a custom salad.",
                4, 10, ""));

        addItem(new FoodMenu(null, "Mini Cheeseburgers", "Starters",
        ...
        addItem(new FoodMenu(null, "Panko Stuffed Mushrooms", "Starters",
        ...
        addItem(new FoodMenu(null, "French Onion Soup", "Starters",
        ...
        addItem(new FoodMenu(null, "Artichokes with Garlic Aeoli", "Starters",
        ...
        addItem(new FoodMenu(null, "Parmesan Deviled Eggs", "Starters",
                "SOME SAY OUR EGGS ARE DEVILISHLY GOOD. I HAVE TO AGREE.\n" +
                        "These delectable little bites are made with organic eggs, fresh Parmesan, and chopped pine nuts.\"",
                5, 8, "deviled_eggs.jpg"));

        addItem(new FoodMenu(null, "Classic Burger", "Entrees",
        ...
        addItem(new FoodMenu(null, "Tomato Bruschetta Tortellini", "Entrees",
        ...
        addItem(new FoodMenu(null, "Handcrafted Pizza", "Entrees",
        ...
        addItem(new FoodMenu(null, "Barbecued Tofu Skewers", "Entrees",
        ...
        addItem(new FoodMenu(null, "Fiesta Family Platter", "Entrees",
        ...
        addItem(new FoodMenu(null, "Crème Brûlée", "Desserts",
    ...
    private static void addItem(FoodMenu item) {
        dataItemList.add(item);
        dataItemMap.put(item.itemId, item);
    }
